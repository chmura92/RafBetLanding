...
export const galleryItems: GalleryItem[] = [
  ...
  { src: gallery07, caption: 'Tafla gotowa pod parkiet', category: 'Dom', visible: true },
  { src: gallery08, caption: 'Pętle ogrzewania, laser, narzędzia', category: 'Proces', visible: true },
